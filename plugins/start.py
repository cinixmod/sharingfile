...
async def start_command(client: Client, message: Message):
    ...
    if len(text)>7:
        ...
        k = await client.send_message(chat_id = message.from_user.id, text=f"<b>❗️ <u>IMPORTANT</u> ❗️</b>\n\nThis Post / File Will Be Deleted In {file_auto_delete} (Due To Copyright Issues).\n\n📌 Please Forward This Post / File To Somewhere Else And Start Downloading There.")
        ...
        # for madflix_msg in madflix_msgs: 
            # try:
                ...
                # await k.edit_text("Your Post / File Is Successfully Deleted ✅") 
            # except:    
                # pass 
